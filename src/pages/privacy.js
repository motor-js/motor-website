    ...
    <Layout title="License">
      <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column'}}>
        ...
        <div style={{ padding: '20px 300px'}}>
          ...
          It is Motor JS' policy to respect your privacy regarding any information we may collect from you across our website, <b>https://www.motor-js.io</b>, and other sites we own and operate. <br /><br />
          ...
          This policy is effective as of 01 August 2020.<br /><br />
        </div>
      </div>
    </Layout>
  )
