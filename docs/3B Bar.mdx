...
<table>
  ...
  <tr>
    ...
    <td>Chart width as a number which will be converted to pixels. If not set, the parent container width will be used</td>
    <td>
      <code>number</code>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>Number of ticks for the second Y Axis. Leave blank to auto calculate</td>
    <td>
      <code>number</code>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>Turns the crosshair on or off. This appears alongside the tooltip when a bar is hovered over</td>
    <td>
      <code>boolean</code>
    </td>
  </tr>
