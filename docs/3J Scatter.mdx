...
#### Scatter chart. A chart displaying a scatter chart.

![Scatter Gif](../static/img/gifs/Scatter1.gif)

## Usage

```javascript

import { Scatter } from @motor-js/core
//...
  <Scatter
    width={750}
    height={400}
    ...
    cols={[
      { qField: 'Product Sub Group', qLabel: 'Product Sub Group' },
      {
        qField: '=Sum({$<[Year]={"2007"}>}[Sales Amount])',
        qLabel: 'TY Sales',
      },
      {
        qField: '=Sum([Sales Margin Amount])/Sum([Sales Amount])',
        qLabel: 'Margin %',
      },
    ]}
  />
...
<table>
  ...
  <tr>
    ...
    <td>Number of decimal precsion when displaying scatter labels</td>
    <td>
      <code>number</code>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>Group values over a certain number of items</td>
    <td>
      <code>bool</code>
      <br />
      <code>shape</code>
  ...
  <tr>
    ...
    <td>Name of the parent grid to place the chart</td>
    <td>
      <code>string</code>
    </td>
  </tr>
  ...
  <tr>
    <td>
      <code>useSingleColor</code>
    </td>
    <td>Use only a sinlge color in the tooltip</td>
    <td>
      <code>bool</code>
    </td>
  </tr>
  ...
  <tr>
    <td>
      <code>crossHairStyles</code>
    </td>
    <td>Styling for the crosshair</td>
    <td>
      <code>object</code>
      <br />
      'e.g.'
      <br />' &#123; fullHeight: false, <br />
      fullWidth: false, <br />
      lineStyles: &#123; pointerEvents: "none", &#125;, <br />
      showCircle: true, <br />
      showMultipleCircles: true, <br />
      showHorizontalLine: true, <br />
      showVerticalLine: true, <br />
      stroke: "multi", <br />
      strokeDasharray: "5,2", <br />
      strokeWidth: 1, <br />
      circleSize: 5, <br />
      circleStyles: &#123; pointerEvents: "none", &#125;, <br />
      circleFill: "white", <br />
      circleClosestFill: "multi", <br />
      circleStroke: "multi",
      <br />
      circleClosestStroke: "multi", <br />
      circleStrokeWidth: 1, <br />
...
The first example is a scatter chart sorted with conditional chart colouring.

![Scatter Color Gif](../static/img/gifs/Scatter2.gif)
  ...
  return (
    <Motor config={config}>
      <Scatter
        ...
        cols={[
          {
            qField: "Supplier Name",
            qLabel: "Supplier Name",
            qCondChartColor:
              "=if(Avg(([Supplier Complaints])>12) or (Avg([Supplier Satisfaction Rating])<10),'Red', 'Green')",
          },
          {
            qField: "=[Supplier Complaints]/Sum(ClaimCounter)",
            qLabel: "Ave Supplier Complaints",
          },
          {
            qField: "=Avg([Supplier Satisfaction Rating])",
            qLabel: "Ave Supplier Satisfaction Rating",
          },
        ]}
      />
    </Motor>
...
Most of the chart settings are in global.chart. Changing any setting in the above will apply to all charts within the application. Specific scatter chart related theme items are stored in scatter. Changing these settings will apply to all scatter charts within the application.
