...
#### Combo chart. A chart displaying data as either a bar or line.

![Combo Gif](https://media.giphy.com/media/TCEFcqkrDRAoFzhLE8/giphy.gif)

## Usage

```javascript

import { Combo } from @motor-js/core
//...
      <Combo
        width={750}
        height={400}
...
### Change colors using Color Theme property

![Combo Gif](https://media.giphy.com/media/fC2ZkndjesAU1mNCET/giphy.gif)
