...
Most of the chart settings are in base.global.chart. Changing any setting in the above will apply to all charts within the application. Specific pie chart related theme items are stored in base.pie. Changing these settings will apply to all pie charts within the application.
